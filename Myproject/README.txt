...
to generate a random number as a job number and "Poll" to request the fibonacci sequence Meanwhile, fibonacci sequence will be generated according to the length by users input. In the end, it will jump to the third page to show those fibonacci sequence on web page.
